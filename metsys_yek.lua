...
Converted["_KeySystem"].Parent = game:GetService("CoreGui")

Converted["_Frame"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_Frame"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_Frame"].BorderSizePixel = 3
Converted["_Frame"].Position = UDim2.new(0.299921572, 0, 0.249653295, 0)
Converted["_Frame"].Size = UDim2.new(0.400000006, 0, 0.5, 0)
Converted["_Frame"].Parent = Converted["_KeySystem"]

Converted["_UICorner"].Parent = Converted["_Frame"]

Converted["_UIStroke"].Color = Color3.fromRGB(255, 0, 4.000000236555934)
Converted["_UIStroke"].Thickness = 3
Converted["_UIStroke"].Parent = Converted["_Frame"]

Converted["_ImageLabel"].Image = "http://www.roblox.com/asset/?id=16323575491"
...
Converted["_TextBox"].Position = UDim2.new(0.349581897, 0, 0.523578346, 0)
Converted["_TextBox"].Size = UDim2.new(0.300000012, 0, 0.150000006, 0)
Converted["_TextBox"].Parent = Converted["_Frame"]

Converted["_TextButton"].Font = Enum.Font.SourceSans
Converted["_TextButton"].Text = "Check Key"
Converted["_TextButton"].TextColor3 = Color3.fromRGB(0, 255, 30.00000201165676)
...
Converted["_TextButton"].Position = UDim2.new(0.349581897, 0, 0.754160821, 0)
Converted["_TextButton"].Size = UDim2.new(0.300000012, 0, 0.150000006, 0)
